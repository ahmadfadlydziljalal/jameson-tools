...
/**
 * This is the base-model class for table "proforma_debit_note_detail_barang".
 *
 * @property integer $id
 ...
 */
abstract class ProformaDebitNoteDetailBarang extends \yii\db\ActiveRecord
{
    ...
    {
        return 'proforma_debit_note_detail_barang';
    }
    ...
    public function rules()
    {
        return ArrayHelper::merge(parent::rules(), [
            [['proforma_debit_note_id', 'barang_id', 'satuan_id', 'discount', 'is_vat'], 'integer'],
