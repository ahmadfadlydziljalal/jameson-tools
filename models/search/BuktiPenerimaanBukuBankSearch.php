...
class BuktiPenerimaanBukuBankSearch extends BuktiPenerimaanBukuBank
{
    ...
    public function search(array $params): ActiveDataProvider
    {
        ...
        if (isset($this->tanggal_transaksi_transfer) and $this->tanggal_transaksi_transfer != '') {
            $query->andFilterWhere([
                'tanggal_transaksi_transfer' => Yii::$app->formatter->asDate($this->tanggal_transaksi_transfer, 'php:Y-m-d'),
            ]);
        }
