...
<?php NavBar::begin([
    ...
    'options' => [
        'id' => 'navbar',
      'class' => 'navbar navbar-expand-md fixed-top' . ' bg-' . Yii::$app->params['theme'] . ' shadow-sm',
//        'class' => 'navbar navbar-expand-md fixed-top' . ' bg-white shadow',
        'data-bs-theme' =>  Yii::$app->params['theme']
    ],
