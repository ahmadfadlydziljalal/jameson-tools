...
<head>
    ...
    <style type="text/css">
        ...
        :root {
            ...
            --base-dark-warning: #343a40;
            --base-dark-error: #495057;
            --base-dark-danger: #6c757d;
            --base-dark-text: #FFF;

            --danger: #ee0037;

            --base-dark-code-comment: #FFF;
            --base-dark-code-keyword: #E6DB74;
            --base-dark-code-number: #F6F8FA;
            --base-dark-code-string: #A6E22E;
            --base-dark-code-symbol: #66D9EF;
            --base-dark-code-variable: #FFF;
        ...
        .header .tools a {
            background-color: var(--base-dark-text);
        }
        ...
        .call-stack ul li .element-wrap {
            cursor: pointer;
            padding: 15px 0;
            background-color: var(--base-dark-error);
            color: var(--base-dark-text);
        }
        ...
        .call-stack ul li .hover-line:hover {
            background: var(--base-dark-warning) !important;
        }
        ...
        .keyword {
            color: var(--base-dark-code-keyword);
        }

        .number {
            color: var(--base-dark-code-number);
        }

        .string, .value {
            color: var(--base-dark-code-string);
        }

        .symbol, .char {
            color: var(--base-dark-code-symbol);
        }
        ...
        .variable {
            color: var(--base-dark-code-variable);
        }
