    ...
    <div class="row">
        <div class="col-12 col-lg-10 col-xl-8">
            ...
            if (!$model->isNewRecord) {
                $data[$model->bukti_pengeluaran_buku_bank_id] =
                    $model->buktiPengeluaranBukuBank->reference_number
                    . ': ' . $model->buktiPengeluaranBukuBank->tujuanBayar . ' ' . Yii::$app->formatter->asCurrency($model->buktiPengeluaranBukuBank->totalBayar)
                ;
            }
